...
```{r}
# create a logical mask for each corpus of size 5%
...
sample_twitter <- corpus_sample(corpus_t, p=0.05)
sample_blog <- corpus_sample(corpus_b, p=0.05)
sample_news <- corpus_sample(corpus_n, p=0.05)
